...
START TRANSACTION;
    SET @Amount=200;
    SET @FromAccount="45615156165";
    SET @ToAccount="456151126165";
    INSERT INTO transactions (to_account, from_account, amount, created_at) VALUES (@ToAccount, @FromAccount, @Amount, "2021-09-26"); 
